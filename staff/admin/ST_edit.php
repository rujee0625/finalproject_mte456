  ...
  <div class="container">
    <form action="ST_edit-p.php" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <input type="text" value="<?= $result['nname']; ?>" class="form-control" name="nname"
          placeholder="Enter Nickname" required="">
      </div>
      <div class="form-group">
        <label for="midscore">Midterm Score:</label>
        <input type="text" value="<?= $result['mid_score']; ?>" class="form-control" name="mid_score"
          placeholder="Enter Midterm Score" required="">
      </div>
      <div class="form-group">
        <label for="finalscore">Final Score:</label>
        <input type="text" value="<?= $result['final_score']; ?>" class="form-control" name="final_score"
          placeholder="Enter Final Score" required="">
      </div>
